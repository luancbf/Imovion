...
export default function ResidencialComprarPage() {
        ...
        <div className="w-full max-w-6xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p
              ...
              style={{ userSelect: "none" }}
            >
              Encontre o imóvel ideal para comprar e realizar o seu sonho! Veja as melhores oportunidades disponíveis.
            </p>
          </div>
          {carregando ? (
            ...
            <div className="text-center text-blue-700 bg-blue-100 border border-blue-200 p-6 rounded-xl shadow mt-10">
              Nenhum imóvel residencial para compra encontrado.
            </div>
          ) : (
