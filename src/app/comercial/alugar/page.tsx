...
// Tipos de imóvel para comercial/aluguel
        ...
        <div className="w-full max-w-11/12 mx-auto">
          <div className="text-center mb-5">
            ...
            <p
              ...
              style={{ userSelect: "none" }}
            >
              Encontre o espaço comercial perfeito para o seu negócio. Veja as melhores opções disponíveis para locação!
            </p>
          </div>
          ...
          {carregando ? (
            ...
            <div className="font-inter text-sm md:text-lg text-center text-blue-700 bg-blue-100 border border-blue-200 p-6 rounded-xl shadow mt-10">
              Nenhum imóvel comercial para aluguel encontrado.
            </div>
          ) : (
