        ...
        <div className="w-full max-w-4xl mx-auto">
          ...
          <div className="flex flex-col md:flex-row gap-10 justify-center items-stretch">
            ...
            <div className="flex-1 bg-white border-2 border-blue-200 rounded-2xl shadow-lg hover:shadow-2xl transition p-8 flex flex-col items-center">
              <h2 className="text-2xl font-bold mb-3 text-blue-700">Plano Premium</h2>
              <ul className="list-disc list-inside text-blue-900 mb-6 text-base space-y-1">
                <li>Até 10 fotos</li>
              ...
              <span className="text-3xl font-extrabold text-blue-700 mb-4 drop-shadow">
                R$ 99,90
              </span>
              <span className="inline-block bg-blue-100 text-blue-700 px-4 py-1 rounded-full text-xs font-semibold mb-2">
                Mais visibilidade
              </span>
            </div>
          </div>
          ...
          <div className="text-center mt-14 flex flex-col items-center">
            ...
            <p
              className="text-xs text-gray-500 text-center mt-4 select-none"
              style={{ userSelect: "none" }}
            >
