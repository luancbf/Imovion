  ...
  return (
    <div className="flex justify-center">
      <Link
        ...
        className="inline-block bg-blue-100 font-poppins text-xl text-blue-700 font-semibold px-5 py-2 rounded-xl shadow hover:bg-blue-200 transition cursor-pointer"
      >
        Anunciado por:{" "}
